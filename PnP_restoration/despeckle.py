...
from utils.utils_restoration import rescale, single2uint,crop_center, matlab_style_gauss2D, imread_uint, imsave, psnr, array2tensor, tensor2array, create_out_dir
...
def despeckle():
    ...
    hparams.pretrained_checkpoint = '../GS_denoising/ckpts/GSDRUNet_grayscale_SAR.ckpt'
    ...
    PnP_module.lamb, PnP_module.lamb_0, PnP_module.lamb_end, PnP_module.maxitr, PnP_module.std_0, PnP_module.std_end, PnP_module.stepsize, PnP_module.sigma_denoiser = PnP_module.hparams.lamb, PnP_module.hparams.lamb_0, PnP_module.hparams.lamb_end, PnP_module.hparams.maxitr, PnP_module.hparams.std_0, PnP_module.hparams.std_end, PnP_module.hparams.stepsize, PnP_module.hparams.sigma_denoiser
    if PnP_module.sigma_denoiser != None:
        PnP_module.std = PnP_module.sigma_denoiser / 255
    ...
    print('GS-DRUNET despeckle with image L:{:.3f}, model sigma:{:.3f}, lamb:{:.3f} \n'.format(PnP_module.hparams.L, PnP_module.sigma_denoiser, PnP_module.lamb))
    ...
    exp_out_path = create_out_dir("../../Result_ERED", hparams)
